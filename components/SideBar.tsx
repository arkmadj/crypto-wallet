  ...
  return (
    <div className="w-[13%] h-full flex flex-col mt-16">
      ...
      <div className="space-y-6">
        <Link href="/">
          <div className="flex bg-pink-200 bg-opacity-30 h-10 rounded-sm cursor-pointer">
        ...
        <Link href="">
          <div className="flex hover:bg-orange-200 hover:bg-opacity-30 h-10 rounded-sm cursor-pointer">
        ...
        <Link href="">
          <div className="flex hover:bg-yellow-200 hover:bg-opacity-30 h-10 rounded-sm cursor-pointer">
        ...
        <Link href="/exchange">
          <div className="flex hover:bg-teal-200 hover:bg-opacity-30 h-10 rounded-sm cursor-pointer">
      ...
      <div className="sticky bottom-0">
        <div className="">
          <p className="text-white ml-10 mb-16 font-bold text-xl">
            Partner Service
          </p>
        </div>
